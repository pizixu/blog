                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>                             
                            ...
                            <td>      
                            <?php if($vo['pic'] != ''): ?><img src="/ykj/Public/Uploads/<?php echo (date("Y-m-d",$vo["time"])); ?>/<?php echo ($vo["pic"]); ?>" height="50"/>
                             <?php else: ?>
                                暂无缩略图<?php endif; ?>
                             </td>
                       
                            <td width="30%"> <?php echo ($vo["catename"]); ?></td>
                            <td width="10%">
                                <a class="link-update" onclick="return confirm('确定要修改该文章嘛?')" href="/ykj/index.php/Admin/Article/edit/id/<?php echo ($vo["id"]); ?>">修改</a>
                                <a class="link-del" onclick="return confirm('确定要删除该文章嘛?')" href="/ykj/index.php/Admin/Article/del/id/<?php echo ($vo["id"]); ?>">删除</a>
                            </td>
