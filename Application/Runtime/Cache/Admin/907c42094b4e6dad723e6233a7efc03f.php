...
<body>
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/jscss/admin/design/">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="/jscss/admin/design/">链接管理</a><span class="crumb-step">&gt;</span><span>编辑链接</span></div>
        </div>
                    ...
                    <table class="insert-tab" width="100%">
                        <tbody> 
                            ...
                            <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="catename" name="title" size="50" value="<?php echo ($links["title"]); ?>" type="text">
                                </td>
                            </tr>
                                  <tr>
                                <th><i class="require-red">*</i>链接地址：</th>
                                <td>
                                    <input class="common-text required" id="catename" name="url" size="50" value="<?php echo ($links["url"]); ?>" type="text">
                                </td>
                            </tr> 
                                  <tr>
                                <th><i class="require-red">*</i>链接描述：</th>
                                <td>
                                    <textarea style="width:380px;height:100px;"><?php echo ($links["desc"]); ?></textarea>
                                </td>
                            </tr>                                                       
                            <tr>
                                <th></th>
