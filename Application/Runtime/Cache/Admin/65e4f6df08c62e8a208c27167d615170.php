...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            <form name="myform" id="myform" method="post" action="/ykj/index.php/Admin/Link/sort">
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>                             
                            ...
                            <td title="<?php echo ($vo["title"]); ?>"><a target="_blank" href="#" title="<?php echo ($vo["title"]); ?>"><?php echo ($vo["title"]); ?></a></td>
                            <td title="<?php echo ($vo["url"]); ?>"><a target="_blank" href="#" title="<?php echo ($vo["url"]); ?>"><?php echo ($vo["url"]); ?></a></td>
                            <td ><?php echo ($vo["desc"]); ?></td>
                            <td width="10%">
                                <a class="link-update" onclick="return confirm('确定要修改该链接嘛?')" href="/ykj/index.php/Admin/Link/edit/id/<?php echo ($vo["id"]); ?>">修改</a>
                                <a class="link-del" onclick="return confirm('确定要删除该链接嘛?')" href="/ykj/index.php/Admin/Link/del/id/<?php echo ($vo["id"]); ?>">删除</a>
                            </td>
